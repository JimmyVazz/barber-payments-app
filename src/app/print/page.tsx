...
const PrintPage: FC = () => {
  const printDiv = (divId: string, optionsData: any) => {
    const { qrCode, name, concept, total, date } = optionsData;
        ...
        <section>
          <div class="container">
            ...
            <div class="data-container">
              ...
              <p class="with-line">Total: ${Number(total)} pesos (mxn)</p>
            </div>
            <div class="image-container-right">
              <img src="${
                qrCode || "https://via.placeholder.com/250x200.png?text=QR+Code"
              }" alt="Imagen Derecha" />
            </div>
          </div>
        </section>
  ...
  return (
    <div>
      ...
      <div className="no-print">
        <p>Este contenido no será impreso.</p>
      </div>
    </div>
  );
};
